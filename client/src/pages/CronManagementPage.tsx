                ...
                <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-600 mt-2">
                                    Monitor and manage automated system tasks
                                    and cron jobs
                                </p>
                            </div>
                            <button
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <p className="text-gray-600 mb-6">
                            ...
                            intervals. You can manually trigger them for testing
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                        ...
                        <div className="space-y-2 text-sm text-blue-800">
                            <p>
                                • Automated tasks run according to their
                                scheduled times shown above
                            </p>
                            <p>
                            ...
                            <p>
                                • All task executions are logged in the audit
                                logs for monitoring
                            </p>
                            <p>
                                • Daily audit log cleanup requires manual
                                control to prevent accidental data loss
                            </p>
                            <p>
                                • Low stock items are checked daily at 9:00 AM
                                with notifications for items ≤ 10 units
                            </p>
                        </div>
                    </div>
                </div>
