            ...
            <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6">
                ...
                <div className="space-y-3">
                    {[1, 2, 3, 4, 5].map((i) => (
                        <div
                            key={i}
                            className="h-14 sm:h-16 bg-gray-100 animate-pulse rounded-lg"
                        ></div>
                    ))}
                </div>
            </div>
        ...
        return (
            <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6">
                ...
                <div className="text-center py-6 sm:py-8">
                    <FiPackage className="mx-auto h-10 w-10 sm:h-12 sm:w-12 text-green-500 mb-4" />
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between sm:justify-end gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                <span
                                    className={`inline-flex items-center px-2 py-1 sm:px-2.5 sm:py-0.5 rounded-full text-xs font-medium border ${getStockLevelColor(
                                        drug.quantity,
                                    )}`}
                                >
